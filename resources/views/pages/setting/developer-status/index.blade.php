...
@section('title', 'Developer Status Settings')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title">Developer Status List</h4>
                        @if (count($statuses) < 5)
                            <a href="{{ route('developer-status.create') }}" class="btn btn-primary btn-round ms-auto">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                ...
                                                <a href="{{ route('developer-status.edit', $status) }}"
                                                    class="btn btn-link btn-primary btn-lg" data-bs-toggle="tooltip"
                                                    title="Edit">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <form action="{{ route('developer-status.destroy', $status) }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-detail', function() {
                ...
                $.get("{{ url('setting/developer-status') }}/" + id, function(data) {
                    var html = `
            ...
            $(document).on('submit', '.form-delete', function(e) {
                ...
                swal({
                    title: "Are you sure?",
                    text: "Once deleted, you will not be able to recover this developer status!",
                    icon: "warning",
                    buttons: {
                        cancel: {
                            text: "Cancel",
