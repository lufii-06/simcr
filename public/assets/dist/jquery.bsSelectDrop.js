(function ($) {
	...
	function init($select) {
		...
		let $dropdown = $('<div>', {
			...
			html: `
				<div class="${settings.btnClass} form-select d-flex flex-nowrap align-items-center" ${closeOutside} href="#" role="button" data-bs-toggle="dropdown"
		...
		const $dropdownMenuInner = $(`<div class="form-control" style="max-height:${settings.dropDownListHeight}px;overflow-y:auto;"></div>`).appendTo($dropdownMenu);
